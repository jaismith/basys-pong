...
HD_PWD='C:/Users/jksmi/Documents/Code/basys-pong/components/input_processor/input_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Input_Controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Input_Controller.tcl -notrace
