...
HD_PWD='C:/Users/jksmi/Documents/Code/basys-pong/components/input_processor/input_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Input_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Input_Controller.tcl
